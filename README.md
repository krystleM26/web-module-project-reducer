...
This simplified calculator adds the entire number selected, rather then adding digits into end of number. In the end of the process, your calculator should function as follows:
